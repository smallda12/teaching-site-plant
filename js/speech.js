...
window.語音 = (function () {
  ...
  let 自動朗讀 = (() => {
    try { return localStorage.getItem("植物小百科:自動朗讀") !== "0"; }
    catch (e) { return true; }
  })();
  function 設自動朗讀(on) {
    自動朗讀 = !!on;
    try { localStorage.setItem("植物小百科:自動朗讀", 自動朗讀 ? "1" : "0"); } catch (e) {}
  ...
  /* 檔名用 word／line 而不是「詞／句」：assets 一律 ASCII 檔名，
     中文檔名放到網路上會被百分比編碼，容易踩到主機或瀏覽器的相容問題 */
